<?php
  ...
  $query = "SELECT mahasiswa.*, kelas.nama AS kelas_nama FROM mahasiswa LEFT JOIN kelas ON mahasiswa.kelas_id = kelas.kelas_id";
      ...
      <div class="row">
        <div class="col-md-4 order-md-2 mb-4">
          <h4 class="d-flex justify-content-between align-items-center mb-3">
            ...
            <span class="badge badge-secondary badge-pill bg-black text-white"><?php echo $total_mahasiswa; ?></span>
          </h4>
          <?php
          foreach ($data_mahasiswa as $index => $value) {
            ...
            <ul class="list-group mb-3">
              <li class="list-group-item d-flex justify-content-between lh-condensed">
                ...
                <span class="text-muted"><?php echo $value['kelas_nama']; ?></span>
              </li>
            </ul>
          <?php
          }
          ...
          <form action="simpan_mahasiswa.php" method="POST">
            ...
            <div class="mb-3">
              ...
              <select class="custom-select d-block w-100" id="Kelas" name="kelas_id" required>
                ...
                <?php foreach($data_kelas as $index =>
                $value){ ?>
